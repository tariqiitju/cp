...
Point closest_pt_iline(Point a, Point b, Point p){//Clossest point on the Line from given point
  double along = dot(b-a,p-a)/lng2(b-a);
  return (b-a)*along + a;
}
Point closest_pt_seg(Point a, Point b, Point p){//Clossest point on the Segment from given point
  double along;
